...
public class AddUserActivity extends AppCompatActivity {
    ...
    private void submitByRetrofit(User user) {
        ...
        proDialog.show();
                                                                             //GANTI LINK APIMU
        Retrofit.Builder builder = new Retrofit.Builder().baseUrl("http://192.168.0.16/retro/").addConverterFactory(GsonConverterFactory.create());
    ...
    private void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "http://192.168.0.16/retro/User_Registration.php"; //GANTI LINK APIMU
